...
var scriptGroup7 = function () {
    ...
    var kvndebugger = '<div id="debugger" ><div id="sceneframe" >Scene <span class="red">demo</span> Frame <span class="blue">2</span></div><div id="ado">Advance Debug Mode</div>&nbsp;<div id="toggle-debug-edit">edit</div><br><div id="advance-debug">' +
            ...
            '<div class="debug-title">Timeline</div><br><div class="debug-holder debug-dark" ><select id="bd-scene-select"></select><input id="frame-number-debug" type="number">' +
            '<button id="go-scene-debug">Go!</button><button id="restart-current-scene">Restart Current Scene</button></div>' +
            '<br><div class="debug-title">Frame State:</div><div class="debug-title" id="debug-state">Running</div>' +
            '<br><div class="debug-title">Frame Skip-able:</div><div class="debug-title" id="skip-state">true</div>' +
            (characterLogging ? '<br><div class="debug-holder debug-dark"><select id="char-logging"></select><button id="s-c-l">Start Character Logging</button></div>' : "") +
